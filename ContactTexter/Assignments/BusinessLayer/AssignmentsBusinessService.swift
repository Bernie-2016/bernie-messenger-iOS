...
class AssignmentsBusinessService {
    ...
    func fetchAssignments(completion: (ServiceResult<[Assignment]>) -> Void) {
        ...
        let assignment2 = Assignment(id: "h41234", expiration: NSDate(), name: "Get Out the Vote in CA", description: "The primary is today! Get out the vote!", type: .Text, instructions: "Send a text to every single friend you can think of who can vote today in CA.", script: "Hi {{firstName}}, are you registered to vote in California?", textActions: textActions2)
